...
def loans_form(request):
    ...
    if request.method == 'POST':
        ...
        partner_1_DOB = request.POST.get('partner1_dob', None)
        partner_2_DOB = request.POST.get('partner2_dob', None)
        partner_3_DOB = request.POST.get('partner3_dob', None)
        partner_4_DOB = request.POST.get('partner4_dob', None)
        partner_5_DOB = request.POST.get('partner5_dob', None)
